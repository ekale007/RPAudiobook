      ...
      <div className="flex items-center gap-1.5 px-3 py-1.5">
        {nav ? (
          <button
            ...
            className="flex max-w-[5rem] shrink-0 items-center gap-1 truncate rounded-full border border-surface-border bg-surface px-1.5 py-1 text-[10px] text-zinc-300 hover:border-accent/40 hover:text-accent disabled:cursor-not-allowed disabled:opacity-30 disabled:hover:border-surface-border disabled:hover:text-zinc-300"
          >
        ...
        <div className="min-w-0 flex-1">
          <div className="mb-1 flex items-center gap-1.5 text-[11px] text-zinc-500">
            <span className="flex min-w-0 items-center gap-1 truncate">
              <span className="shrink-0">{t.chapterProgress}</span>
              {nav && nav.total > 1 ? (
        ...
        {hasMemory ? (
          <button
            ...
            className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-surface-border bg-surface text-zinc-300 hover:border-accent/40 hover:text-accent"
            title={open ? t.memory : t.openMemory}
          ...
          >
            ...
            >
              ...
              <path d="M6.401 17.5a3 3 0 0 0 5.126-1.732" />
              <path d="M20.523 13.104a4 4 0 0 0-.585-.396" />
              <path d="M17.599 17.5a3 3 0 0 1-5.126-1.732" />
            </svg>
            {memory?.syncing ? (
              <span className="absolute -mt-3 ml-3 h-1.5 w-1.5 animate-pulse rounded-full bg-amber-300" />
            ) : null}
          </button>
        ) : null}
        ...
        {closeChapter ? (
          <button
            ...
            className="flex shrink-0 items-center gap-1.5 rounded-full border border-accent/40 bg-accent/10 px-2.5 py-1 text-[11px] font-medium text-accent transition-colors hover:bg-accent/20 disabled:opacity-40"
